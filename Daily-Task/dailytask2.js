...
let hobbyId1 = person.flatMap(function(x3) {
    return x3.friends.filter(function (p3) {
        return p3.id === 1 && p3.isActive === true
    })
})
...
let personBrown = person.filter(function(q) {
    return q.eyeColor === "brown" && (function(q2) {
        return q2.friends.find(function(q3){
            return q3.favoriteFruit === "banana"
        })
    })
})
//masih salah
